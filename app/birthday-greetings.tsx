...
type Category = Database['public']['Tables']['birthday_greetings_categories']['Row'];
type Statement = Database['public']['Tables']['birthday_greetings_statements']['Row'];
type Language = 'en' | 'da';
  ...
  const fetchCategories = async () => {
    try {
      ...
      const { data, error } = await supabase
        .from('birthday_greetings_categories')
        .select('*');
  ...
  const fetchStatements = async (categoryId: string) => {
    try {
      ...
      if (categoryId === RANDOM_CATEGORY_ID) {
        ...
        while (hasMore) {
          const { data, error } = await supabase
            .from('birthday_greetings_statements')
            .select('*')
    ...
    return (
      <ScrollView 
        ...
        <Text style={styles.title}>
          {t('birthdayGreetings.categories.title')}
        </Text>
        ...
        <Pressable
          ...
          <Text style={styles.startButtonText}>
            {t('birthdayGreetings.findGreetings')}
          </Text>
        </Pressable>
      </ScrollView>
    );
    ...
    <ScrollView 
      ...
      <Pressable
        ...
        <Text style={styles.nextButtonText}>
          {t('birthdayGreetings.nextGreeting')}
        </Text>
      </Pressable>
    </ScrollView>
  );
