...
type Category = Database['public']['Tables']['charades_categories']['Row'];
type Statement = Database['public']['Tables']['charades_statements']['Row'];
type Language = 'en' | 'da';
