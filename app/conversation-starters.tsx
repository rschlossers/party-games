...
type Category = Database['public']['Tables']['conversation_starters_categories']['Row'];
type Statement = Database['public']['Tables']['conversation_starters_statements']['Row'];
type Language = 'en' | 'da';
  ...
  const fetchCategories = async () => {
    try {
      ...
      const { data, error } = await supabase 
        .from('conversation_starters_categories')
        .select('*');
  ...
  const fetchStatements = async (categoryId: string) => {
    try {
      ...
      if (categoryId === RANDOM_CATEGORY_ID) {
        ...
        while (hasMore) {
          const { data, error } = await supabase
            .from('conversation_starters_statements')
            .select('*')
    ...
    return (
      <ScrollView 
        ...
        <Text style={styles.title}>
          {t('conversationStarters.categories.title')}
        </Text>
        ...
        <Pressable
          ...
          <Text style={styles.startButtonText}>
            {t('conversationStarters.findConversation')}
          </Text>
        </Pressable>
      </ScrollView>
    );
    ...
    <ScrollView 
      ...
      <Pressable
        ...
        <Text style={styles.nextButtonText}>
          {t('conversationStarters.nextConversation')}
        </Text>
      </Pressable>
    </ScrollView>
  );
