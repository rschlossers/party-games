...
type Category = Database['public']['Tables']['date_ideas_categories']['Row'];
type Statement = Database['public']['Tables']['date_ideas_statements']['Row'];
type Language = 'en' | 'da';
