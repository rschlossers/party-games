...
type Category = Database['public']['Tables']['do_or_drink_categories']['Row'];
type Statement = Database['public']['Tables']['do_or_drink_statements']['Row'];
type Language = 'en' | 'da';
