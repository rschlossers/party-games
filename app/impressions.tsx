...
type Category = Database['public']['Tables']['impressions_categories']['Row'];
type Statement = Database['public']['Tables']['impressions_statements']['Row'];
type Language = 'en' | 'da';
    ...
    return (
      <ScrollView 
        ...
        <Text style={styles.title}>
          {t('impressions.categories.title')}
        </Text>
