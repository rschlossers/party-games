...
type Category = Database['public']['Tables']['never_have_i_ever_categories']['Row'];
type Statement = Database['public']['Tables']['never_have_i_ever_statements']['Row'];
type Language = 'en' | 'da';
  ...
  const fetchCategories = async () => {
    try {
      ...
      const { data, error } = await supabase 
        .from('never_have_i_ever_categories')
        .select('*');
    ...
    return (
      <ScrollView 
        ...
        <Text style={styles.title}>
          {t('neverHaveIEver.categories.title')}
        </Text>
