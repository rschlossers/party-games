...
type Category = Database['public']['Tables']['photo_challenges_categories']['Row'];
type Statement = Database['public']['Tables']['photo_challenges_statements']['Row'];
type Language = 'en' | 'da';
  ...
  const fetchCategories = async () => {
    try {
      ...
      const { data, error } = await supabase 
        .from('photo_challenges_categories')
        .select('*');
  ...
  const fetchStatements = async (categoryId: string) => {
    try {
      ...
      if (categoryId === RANDOM_CATEGORY_ID) {
        ...
        while (hasMore) {
          const { data, error } = await supabase
            .from('photo_challenges_statements')
            .select('*')
    ...
    return (
      <ScrollView 
        ...
        <Text style={styles.title}>
          {t('photoChallenges.categories.title')}
        </Text>
        ...
        <Pressable
          ...
          <Text style={styles.startButtonText}>
            {t('photoChallenges.findChallenge')}
          </Text>
        </Pressable>
      </ScrollView>
    );
    ...
    <ScrollView 
      ...
      <Pressable
        ...
        <Text style={styles.nextButtonText}>
          {t('photoChallenges.nextChallenge')}
        </Text>
      </Pressable>
    </ScrollView>
  );
