...
type Category = Database['public']['Tables']['pickup_lines_categories']['Row'];
type Statement = Database['public']['Tables']['pickup_lines_statements']['Row'];
type Language = 'en' | 'da';
    ...
    return (
      <ScrollView 
        ...
        <Text style={styles.title}>
          {t('pickupLines.categories.title')}
        </Text>
