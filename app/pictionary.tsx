...
type Category = Database['public']['Tables']['pictionary_categories']['Row'];
type Statement = Database['public']['Tables']['pictionary_statements']['Row'];
type Language = 'en' | 'da';
