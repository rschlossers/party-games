...
type Category = Database['public']['Tables']['random_theme_categories']['Row'];
type Statement = Database['public']['Tables']['random_theme_statements']['Row'];
type Language = 'en' | 'da';
    ...
    return (
      <ScrollView 
        ...
        <Text style={styles.title}>
          {t('randomTheme.categories.title')}
        </Text>
          ...
          {statements[currentStatement] ? (
            <>
              <Text style={styles.statementText}>
                {statements[currentStatement][`text_${language as Language}` as 'text_en' | 'text_da']}
              </Text>
