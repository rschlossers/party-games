...
type Category = Database['public']['Tables']['taskmaster_categories']['Row'];
type Statement = Database['public']['Tables']['taskmaster_statements']['Row'];
type Language = 'en' | 'da';
